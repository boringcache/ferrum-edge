...
- TLS path validation follows security rules in `.claude/rules/tls-security.md`.
- Plugin file dependency validation follows plugin rules in `.claude/rules/plugins.md`.
