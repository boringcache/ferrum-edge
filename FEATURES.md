...
- **SPIFFE identity** — extracted from mTLS peer certificates and HBONE W3C Baggage headers with trust-domain aliasing for federated multi-cluster. Workload API serves X.509-SVIDs; JWT-SVID mint/validate/bundle streaming remains deferred ([#3617](https://github.com/ferrum-edge/ferrum-edge/issues/3617))
