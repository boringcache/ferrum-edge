...
- 69 built-in plugins with lifecycle hooks (request received, authenticate, authorize, before proxy, backend admission, after proxy, on final request/response body, on response body, on WebSocket frame, on UDP datagram, log)
