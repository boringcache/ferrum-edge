...
review-trigger cadence, final reporting, safeguard notices, and the prohibition on merging.
...
review-thread dispositions, CI state, any refusal or model-fallback notice, and anything the next
round must reconstruct.
