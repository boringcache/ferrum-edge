...
pub const BUILTIN_PLUGIN_PARITY_META: &[BuiltinPluginParityMeta] = &[
    ...
    BuiltinPluginParityMeta {
        ...
        classification: BuiltinPluginClassification::Public,
        priority: 2740,
        active_phases: "before_proxy, on_final_request_body, after_proxy, on_final_response_body, on_response_committed, response_stream_inspector, on_response_stream_terminated, log",
        matrix_protocols: HTTP_GRPC_PROTOCOLS,
    ...
    BuiltinPluginParityMeta {
        ...
        classification: BuiltinPluginClassification::Public,
        priority: 2950,
        active_phases: "before_proxy, on_final_request_body, after_proxy, finalize_client_visible_response_body",
        matrix_protocols: HTTP_GRPC_PROTOCOLS,
    ...
    BuiltinPluginParityMeta {
        ...
        classification: BuiltinPluginClassification::Public,
        priority: 3500,
        active_phases: "before_proxy, after_proxy, on_final_response_headers, on_final_response_body",
        matrix_protocols: HTTP_ONLY_PROTOCOLS,
    ...
    BuiltinPluginParityMeta {
        ...
        classification: BuiltinPluginClassification::Public,
        priority: 4050,
        active_phases: "normalize_buffered_request_body_before_before_proxy, before_proxy, after_proxy, transform_request_body_with_context, transform_response_body_with_context",
        matrix_protocols: HTTP_ONLY_PROTOCOLS,
    ...
    BuiltinPluginParityMeta {
        ...
        classification: BuiltinPluginClassification::Public,
        priority: 4075,
        active_phases: "after_proxy, on_response_body, transform_response_body, finalize_client_visible_response_body",
        matrix_protocols: HTTP_GRPC_PROTOCOLS,
    ...
    BuiltinPluginParityMeta {
        ...
        classification: BuiltinPluginClassification::Public,
        priority: 4200,
        active_phases: "before_proxy, after_proxy, on_response_body, response_stream_inspector, on_response_stream_terminated",
        matrix_protocols: HTTP_ONLY_PROTOCOLS,
    ...
    BuiltinPluginParityMeta {
        ...
        classification: BuiltinPluginClassification::Public,
        priority: 9050,
        active_phases: "on_ws_frame, on_ws_disconnect",
        matrix_protocols: WS_ONLY_PROTOCOLS,
