...
mod tests {
    ...
    #[test]
    fn http_route_headless_selectorless_service_uses_ready_endpoint_slice_targets() {
        let service = core_service(
        ...
        .expect("headless selectorless EndpointSlice service should translate");
    ...
    #[test]
    fn http_route_headless_selectorless_dns_fallback_dials_target_port() {
        let service = core_service(
            "headless-manual-endpointslices",
            serde_json::json!({
                "clusterIP": "None",
        ...
        .expect("headless selectorless DNS fallback should translate");
        ...
        assert_eq!(
            ...
            "headless DNS returns pod IPs; dial targetPort, not Service port 8080"
        );
        assert!(
            result.config.upstreams.is_empty(),
