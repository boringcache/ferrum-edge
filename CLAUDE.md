...
- `FERRUM_CP_REQUIRE_NAMESPACE_CLAIM` (`false`) — when `true`, DP/mesh JWTs must carry an `ns` claim (string or array) authorising the subscribe namespace. Multi-tenant deployments should enable
