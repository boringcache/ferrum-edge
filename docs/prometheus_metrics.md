...
| `ferrum_service_discovery_tasks_readiness_failing` | gauge | `namespace` | `service_discovery` | `documented_only` | `always` | Stale service-discovery tasks configured with the fail_readiness expiry policy. |
