...
| `ferrum_mesh_workload_api_active_rpcs` | gauge | `gateway_namespace` | `mesh` | `documented_only` | `conditional` | SPIFFE Workload API RPCs currently admitted by the service-wide concurrency ceiling. |
...
| `ferrum_mesh_workload_api_rpcs_rejected_total` | counter | `gateway_namespace` | `mesh` | `documented_only` | `conditional` | SPIFFE Workload API RPCs shed by the service-wide concurrency ceiling before any producer work was spawned. |
