...
| `ferrum_mesh_request_bytes` | histogram | `source_workload`, `source_namespace`, `source_principal`, `source_app`, `source_service`, `destination_workload`, `destination_namespace`, `destination_principal`, `destination_app`, `destination_service`, `request_protocol`, `response_code`, `response_flags`, `connection_security_policy`, `gateway_namespace`, `le` | `mesh` | `dashboard` | `conditional` | Mesh HTTP/gRPC request body size in bytes. |
...
| `ferrum_mesh_response_bytes` | histogram | `source_workload`, `source_namespace`, `source_principal`, `source_app`, `source_service`, `destination_workload`, `destination_namespace`, `destination_principal`, `destination_app`, `destination_service`, `request_protocol`, `response_code`, `response_flags`, `connection_security_policy`, `gateway_namespace`, `le` | `mesh` | `dashboard` | `conditional` | Mesh HTTP/gRPC response body size in bytes. |
