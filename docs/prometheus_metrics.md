...
| `ferrum_mesh_tcp_received_bytes_total` | counter | Mesh identity, protocol, response flags, security policy, namespace | Bytes the gateway received backend->client on closed connections. Istio's `istio_tcp_received_bytes_total` is the opposite direction. |
| `ferrum_mesh_tcp_sent_bytes_total` | counter | Mesh identity, protocol, response flags, security policy, namespace | Bytes the gateway sent client->backend on closed connections. Istio's `istio_tcp_sent_bytes_total` is the opposite direction. |
...
| `ferrum_mesh_tcp_received_bytes_total` | counter | `source_workload`, `source_namespace`, `source_principal`, `source_app`, `source_service`, `destination_workload`, `destination_namespace`, `destination_principal`, `destination_app`, `destination_service`, `request_protocol`, `response_flags`, `connection_security_policy`, `gateway_namespace` | `mesh` | `documented_only` | `conditional` | Mesh TCP bytes the gateway received backend->client on closed connections. |
| `ferrum_mesh_tcp_sent_bytes_total` | counter | `source_workload`, `source_namespace`, `source_principal`, `source_app`, `source_service`, `destination_workload`, `destination_namespace`, `destination_principal`, `destination_app`, `destination_service`, `request_protocol`, `response_flags`, `connection_security_policy`, `gateway_namespace` | `mesh` | `documented_only` | `conditional` | Mesh TCP bytes the gateway sent client->backend on closed connections. |
