...
**Config fields:** `ttl_seconds`, `max_entries`, `max_entry_size_bytes`, `max_total_size_bytes`, `include_model_in_key`, `include_params_in_key`, `scope_by_consumer`, and the optional semantic/Redis settings documented in [Plugins](plugins.md#ai-semantic-cache).
