...
- `ai_prompt_compressor` (4055) boundedly shortens admitted OpenAI Chat/Text Completions plaintext, stages compatible direct-dispatch metadata while limiting private wire-result reuse to 65,536 bytes, and records authoritative standard wire stats after request decompression; successful rewrites reserialize the complete JSON body
