...
| `buffer_max_bytes` | Integer | `16777216` | Aggregate retained serialized-content budget across queued and retrying records (must be ≥ `max_entry_bytes`; hard max 268435456). Admission reserves before serialization. |
...
| `buffer_max_bytes` | Integer | `16777216` | Aggregate retained serialized-content budget across queued and retrying records (must be ≥ `max_entry_bytes`). |
