...
| `mesh-performance-baselines.yml` | Mesh Performance Baselines | Manual | Provenance-complete collection of mesh Criterion + HBONE/DNS E2E baseline artifacts for [#3332](https://github.com/ferrum-edge/ferrum-edge/issues/3332). Uploads `mesh-performance-baselines-<sha>`; does not invent `baseline.md` numbers. |
