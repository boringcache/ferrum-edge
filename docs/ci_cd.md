...
Pull Request
    └─► CI plan
            ...
            └─► Full CI
                    ...
                    ├─► Gateway / planner-gated mesh / Helm / performance gates
...
shards, lint, dependency audit, vendored patch regressions, the Coverage
workflow mirror, Gateway/mesh/Helm gates, eBPF/netns gates, performance, and the
