...
| `source.serviceAccount` | Istio string match | yes | yes | yes | `<namespace>/<service-account>` from the verified peer SPIFFE ID |
| `source.trustDomain` | Istio string match | yes | yes | yes | trust domain of the verified peer SPIFFE ID |
