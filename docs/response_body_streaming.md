...
One direct-H2 dispatch stays excluded:

- **Translated gRPC-Web.** Its terminal metadata is adapted into a final DATA frame rather than a TRAILERS frame, and the pristine Trailers-Only snapshot already governs what may appear there.
