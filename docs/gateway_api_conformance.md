...
| Claim | Gate |
|---|---|
| Translation, admission, weighted sets, ReferenceGrant, status, update/delete | CI **Unit Tests** — `tests/unit/gateway_core/k8s_udproute_translation_tests.rs` |
