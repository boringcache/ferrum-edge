...
- OpenAPI 3.x request schemas from `requestBody.content.{mediaType}.schema`, preserving `encoding` for `application/x-www-form-urlencoded` and `multipart/form-data` (unsupported Encoding Object combinations fail closed).
