...
| 61 | `ai_federation` | 4060 | before_proxy, finalized request egress, enforce_final_backend_header_policy, on_final_request_body_with_context, after_proxy, response_stream_inspector (HTTP only) |
