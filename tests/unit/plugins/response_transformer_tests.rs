...
async fn claimed_body_rewrite_marks_capacity_refusal_distinct_from_noop() {
    use ferrum_edge::_test_support::{
        ...
        stamp_original_response_metadata_for_test, take_pending_transform_capacity_refusal_for_test,
        transform_buffered_response_body_with_deadline_full_for_test,
    };
    ...
    assert!(
        take_pending_transform_capacity_refusal_for_test(&mut ctx),
    ...
    assert!(
        !take_pending_transform_capacity_refusal_for_test(&mut noop_ctx),
    ...
    assert!(
        !take_pending_transform_capacity_refusal_for_test(&mut loop_ctx),
