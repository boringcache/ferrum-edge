...
#[test]
fn test_proxy_and_plugin_writes_run_security_composition_candidate_validation() {
    let source = include_str!("../../../src/admin/crud.rs");
    assert!(
        source
            .matches("validate_plugin_security_composition_candidates(")
            .count()
            >= 3,
    ...
    let validation = source
        .rfind("validate_plugin_security_composition_candidates(")
...
#[test]
fn test_batch_writes_run_security_composition_candidate_validation() {
    let source = include_str!("../../../src/admin/mod.rs");
    assert!(
        source.contains("crud::validate_plugin_security_composition_candidates("),
